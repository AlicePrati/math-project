/**
 * Maps each app topic ID (from topics.ts) to the corresponding quiz question-set ID
 * (used as `topicId` in the question JSON files).
 *
 * null = this topic has no quiz questions yet.
 * Many-to-one: multiple app topics can share the same question set
 * (e.g., rolle/fermat/lagrange/cauchy_derivate → 'teoremi_derivate').
 */
export const APP_TO_QUIZ: Record<string, string | null> = {
